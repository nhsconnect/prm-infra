...
module "apigw_resource_retrieve" {
  ...
  apigw_integration_lambda_function_arn = "${module.apigw_lambda_retrieve_processed_ehr_extract.lambda_function_arn}"
  apigw_lambda_permission_function_name = "${module.apigw_lambda_retrieve_processed_ehr_extract.lambda_function_name}"
